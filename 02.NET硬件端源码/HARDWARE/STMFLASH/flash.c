...
void W_Test(void)
{
	...
	System_WriteInteriorFlash(addrShort2, (uint8_t *)&threshold_value_init.MQ3_value, sizeof(threshold_value_init.MQ3_value)); // 存入数据，函数内自动解锁，擦除，写入
...
void R_Test(void)
{
	...
	System_ReadInteriorFlash(addrShort2, (uint8_t *)&threshold_value_init.MQ3_value ,sizeof(threshold_value_init.MQ3_value)); // 读取数据，函数内自动按半字读取
